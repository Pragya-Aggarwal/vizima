...
export const BookingConfirmationSection = (): JSX.Element => {
    return (
        <Card className="bg-gradient-to-br from-green to-green border-none shadow-sm rounded-xl sm:rounded-2xl overflow-hidden">
            <div className="p-4 sm:p-6">
                ...
                <div className="flex flex-col sm:flex-row gap-4 mb-5 sm:mb-6">
                    <div className="flex items-center gap-3 sm:gap-4">
                        <div className="p-2 sm:p-2.5 bg-white rounded-xl shadow-sm flex-shrink-0">
                            <Users className="w-5 h-5 sm:w-6 sm:h-6 text-green" />
                        </div>
                        <div className="flex-1">
                            ...
                            <div className="flex flex-wrap gap-2 sm:gap-4">
                                ...
                                <div className="flex items-center gap-1.5 sm:gap-2 text-gray-600">
                                    <Check className="w-3.5 h-3.5 sm:w-4 sm:h-4 flex-shrink-0 text-green" />
                ...
                {/* Action Button */}
                <Button
                    className="w-full bg-green hover:bg-green text-white rounded-lg sm:rounded-xl h-auto py-3 sm:py-4 flex items-center justify-center gap-2 transition-all duration-200 shadow-sm hover:shadow-md active:scale-[0.98]"
                >
