...
export const RentYourSpaceSection = (): JSX.Element => {
    return (
        <Card className="relative w-full max-w-[610px] border-none rounded-none rounded-r-[60px] shadow-none bg-white">
            <CardContent className="flex flex-col items-start gap-8 px-20 py-[30px]">
                <div className="flex flex-col w-full max-w-[569px] items-start gap-6">
